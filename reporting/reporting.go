...
func (r *Reporter) generateReportAttachment(member model.ChannelMember, project model.Channel) slack.Attachment {
	...
	fieldValue, whoAndWhere, points := r.PrepareAttachment(member, project, dataOnUser, dataOnUserInProject, isNonReporter, collectorError)

	return r.GenerateAttachment(fieldValue, whoAndWhere, points)
}
...
func (r *Reporter) PrepareAttachment(user model.ChannelMember, project model.Channel, dataOnUser, dataOnUserInProject teammonitoring.CollectorData, isNonReporter bool, collectorError error) (string, string, int) {
	...
	return fieldValue, whoAndWhere, points
}

func (r *Reporter) GenerateAttachment(fieldValue, whoAndWhere string, points int) slack.Attachment {
