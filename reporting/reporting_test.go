...
func TestDisplayYesterdayTeamReport(t *testing.T) {
	...
	url1_1 := "www.collector.some/rest/api/v1/logger//users/uid1/2018-12-10/2018-12-10/"
	httpmock.RegisterResponder("GET", url1_1, httpmock.NewStringResponder(200, `{"total_commits":1,"worklogs":20000}`))
	url1_2 := "www.collector.some/rest/api/v1/logger//user-in-project/uid1/testChannel1/2018-12-10/2018-12-10/"
	...
	url2_1 := "www.collector.some/rest/api/v1/logger//users/uid2/2018-12-10/2018-12-10/"
	httpmock.RegisterResponder("GET", url2_1, httpmock.NewStringResponder(200, `{"total_commits":1,"worklogs":28000}`))
	url2_2 := "www.collector.some/rest/api/v1/logger//user-in-project/uid2/testChannel1/2018-12-10/2018-12-10/"
	...
	url4_1 := "www.collector.some/rest/api/v1/logger//users/uid4/2018-12-10/2018-12-10/"
	httpmock.RegisterResponder("GET", url4_1, httpmock.NewStringResponder(200, `{"total_commits":1,"worklogs":28000}`))
	url4_2 := "www.collector.some/rest/api/v1/logger//user-in-project/uid4/testChannel1/2018-12-10/2018-12-10/"
